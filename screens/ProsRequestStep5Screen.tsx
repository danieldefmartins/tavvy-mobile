...
const styles = StyleSheet.create({
  ...
  content: { padding: 20 },
  title: { fontSize: 24, fontWeight: '800', color: '#1E0A3C', marginBottom: 8 },
  ...
  sectionValue: { fontSize: 18, fontWeight: '700', color: '#1E0A3C', marginBottom: 2 },
  ...
  modalTitle: { fontSize: 24, fontWeight: '800', color: '#1E0A3C', marginBottom: 12 },
