...
export default function OnTheGoScreen() {
 ...
 const [view,setView]=useState<'list'|'map'>('list'),[search,setSearch]=useState(''),[filter,setFilter]=useState('all'),[mapStyle,setMapStyle]=useState<keyof typeof MAP_STYLES>('osm');
