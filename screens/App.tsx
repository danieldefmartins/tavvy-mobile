...
function TabNavigator() {
  ...
  return (
    ...
    >
      <Tab.Screen name="Home" component={HomeStack} options={{ tabBarLabel: t('navigation.home') }} />
      <Tab.Screen name="Explore" component={UniverseStack} options={{ tabBarLabel: t('navigation.universes') }} />
      ...
      <Tab.Screen
        ...
        component={ProsStack}
        options={{
          tabBarLabel: t('navigation.pros'),
        }}
      />

      <Tab.Screen name="Atlas" component={AtlasStack} options={{ tabBarLabel: t('navigation.atlas') }} />
      <Tab.Screen name="Apps" component={AppsStack} options={{ tabBarLabel: t('navigation.apps') }} />
    </Tab.Navigator>
  );
}
  ...
  useEffect(() => {
    const initializeApp = async () => {
      try {
        ...
        // Preload both signal caches in parallel
        await Promise.all([
          preloadSignalLabels(),
          preloadSignalCache(),
        ]);
