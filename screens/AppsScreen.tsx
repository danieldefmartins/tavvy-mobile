...
export default function AppsScreen() {
  ...
  return <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
      ...
      <View style={{padding:16,marginBottom:24,borderWidth:1,borderRadius:16,borderColor:colors.border,backgroundColor:colors.surface}}><AppearanceSelector /></View>
