 ...
 * UPDATED: Categories sorted alphabetically
 */
...
export type ContentType = 'place_or_business' | 'city' | 'universe';
...
export interface ContentTypeConfig {
  ...
  allowedCategories: string[]; // Primary category slugs (empty = all categories)
}
...
// ============================================
// CONTENT TYPES (Updated: 3 types instead of 4)
// ============================================

export const CONTENT_TYPES: ContentTypeConfig[] = [
  {
    id: 'place_or_business',
    label: 'Place or Business',
    description: 'A physical location or service business',
    icon: 'location',
  ...
  },
  {
    id: 'city',
    label: 'City',
    description: 'A city as a reviewable destination',
    icon: 'business',
  ...
  },
  {
    ...
    icon: 'globe',
    allowedCategories: [
      'transportation', 'entertainment', 'outdoors', 'rv_camping', 'education', 'health',
...
// ============================================
// PRIMARY CATEGORIES (Sorted Alphabetically)
// ============================================
...
export const PRIMARY_CATEGORIES: PrimaryCategory[] = [
  ...
  // ----------------------------------------
  {
    ...
    sortOrder: 2,
    multiEntrance: 'optional',
    alwaysMultiEntranceSubcategories: ['car_dealership'],
    optionalMultiEntranceSubcategories: ['auto_repair'],
    subcategories: [
      { slug: 'car_dealership', name: 'Car Dealership', iconKey: 'car', sortOrder: 1 },
      { slug: 'used_car_dealer', name: 'Used Car Dealer', iconKey: 'car', sortOrder: 2 },
      ...
      { slug: 'auto_repair', name: 'Auto Repair', iconKey: 'build', sortOrder: 6 },
      { slug: 'oil_change', name: 'Oil Change', iconKey: 'water', sortOrder: 7 },
      { slug: 'tire_shop', name: 'Tire Shop', iconKey: 'ellipse', sortOrder: 8 },
      { slug: 'brake_shop', name: 'Brake Shop', iconKey: 'stop', sortOrder: 9 },
      { slug: 'transmission', name: 'Transmission Shop', iconKey: 'cog', sortOrder: 10 },
      { slug: 'muffler_exhaust', name: 'Muffler / Exhaust', iconKey: 'build', sortOrder: 11 },
      { slug: 'auto_body', name: 'Auto Body Shop', iconKey: 'color-palette', sortOrder: 12 },
      { slug: 'auto_glass', name: 'Auto Glass', iconKey: 'square', sortOrder: 13 },
      { slug: 'auto_detailing', name: 'Auto Detailing', iconKey: 'sparkles', sortOrder: 14 },
      { slug: 'car_wash', name: 'Car Wash', iconKey: 'water', sortOrder: 15 },
      { slug: 'auto_parts', name: 'Auto Parts Store', iconKey: 'cog', sortOrder: 16 },
      { slug: 'gas_station', name: 'Gas Station', iconKey: 'flame', sortOrder: 17 },
      { slug: 'ev_charging', name: 'EV Charging Station', iconKey: 'flash', sortOrder: 18 },
      { slug: 'towing', name: 'Towing Service', iconKey: 'car', sortOrder: 19 },
      { slug: 'car_rental', name: 'Car Rental', iconKey: 'car', sortOrder: 20 },
      { slug: 'truck_rental', name: 'Truck Rental', iconKey: 'car', sortOrder: 21 },
      { slug: 'parking', name: 'Parking', iconKey: 'car', sortOrder: 22 },
      { slug: 'dmv', name: 'DMV', iconKey: 'document', sortOrder: 23 },
  ...
  // ----------------------------------------
  {
    ...
    sortOrder: 6,
    multiEntrance: 'optional',
    alwaysMultiEntranceSubcategories: ['university'],
    optionalMultiEntranceSubcategories: ['high_school', 'community_college'],
    subcategories: [
      { slug: 'preschool', name: 'Preschool', iconKey: 'happy', sortOrder: 1 },
      { slug: 'daycare', name: 'Daycare', iconKey: 'happy', sortOrder: 2 },
      { slug: 'elementary_school', name: 'Elementary School', iconKey: 'school', sortOrder: 3 },
      { slug: 'middle_school', name: 'Middle School', iconKey: 'school', sortOrder: 4 },
      { slug: 'high_school', name: 'High School', iconKey: 'school', sortOrder: 5 },
      { slug: 'charter_school', name: 'Charter School', iconKey: 'school', sortOrder: 6 },
      { slug: 'private_school', name: 'Private School', iconKey: 'school', sortOrder: 7 },
      { slug: 'boarding_school', name: 'Boarding School', iconKey: 'school', sortOrder: 8 },
      { slug: 'montessori', name: 'Montessori School', iconKey: 'school', sortOrder: 9 },
      { slug: 'waldorf', name: 'Waldorf School', iconKey: 'school', sortOrder: 10 },
      { slug: 'special_education', name: 'Special Education', iconKey: 'school', sortOrder: 11 },
      { slug: 'vocational_school', name: 'Vocational School', iconKey: 'build', sortOrder: 12 },
      { slug: 'trade_school', name: 'Trade School', iconKey: 'hammer', sortOrder: 13 },
      { slug: 'community_college', name: 'Community College', iconKey: 'school', sortOrder: 14 },
      { slug: 'university', name: 'University', iconKey: 'school', sortOrder: 15 },
      { slug: 'graduate_school', name: 'Graduate School', iconKey: 'school', sortOrder: 16 },
      { slug: 'law_school', name: 'Law School', iconKey: 'briefcase', sortOrder: 17 },
      { slug: 'medical_school', name: 'Medical School', iconKey: 'medkit', sortOrder: 18 },
      { slug: 'business_school', name: 'Business School', iconKey: 'briefcase', sortOrder: 19 },
      { slug: 'art_school', name: 'Art School', iconKey: 'color-palette', sortOrder: 20 },
      { slug: 'music_school', name: 'Music School', iconKey: 'musical-notes', sortOrder: 21 },
      { slug: 'culinary_school', name: 'Culinary School', iconKey: 'restaurant', sortOrder: 22 },
      { slug: 'cosmetology_school', name: 'Cosmetology School', iconKey: 'cut', sortOrder: 23 },
      { slug: 'driving_school', name: 'Driving School', iconKey: 'car', sortOrder: 24 },
      { slug: 'flight_school', name: 'Flight School', iconKey: 'airplane', sortOrder: 25 },
      { slug: 'language_school', name: 'Language School', iconKey: 'language', sortOrder: 26 },
      { slug: 'test_prep', name: 'Test Prep', iconKey: 'document', sortOrder: 27 },
      { slug: 'tutoring', name: 'Tutoring Center', iconKey: 'book', sortOrder: 28 },
      { slug: 'learning_center', name: 'Learning Center', iconKey: 'book', sortOrder: 29 },
      { slug: 'coding_bootcamp', name: 'Coding Bootcamp', iconKey: 'code', sortOrder: 30 },
      { slug: 'online_school', name: 'Online School', iconKey: 'globe', sortOrder: 31 },
      { slug: 'adult_education', name: 'Adult Education', iconKey: 'school', sortOrder: 32 },
      { slug: 'library', name: 'Library', iconKey: 'library', sortOrder: 33 },
    ],
  },
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      ...
      { slug: 'theme_park_ride', name: 'Theme Park Ride', iconKey: 'rocket', sortOrder: 27 },
      { slug: 'theme_park_attraction', name: 'Attraction / Show', iconKey: 'star', sortOrder: 28 },
      { slug: 'theme_park_food', name: 'Theme Park Food Stand', iconKey: 'fast-food', sortOrder: 29 },
      { slug: 'theme_park_restroom', name: 'Restroom', iconKey: 'water', sortOrder: 30 },
      { slug: 'haunted_house', name: 'Haunted House', iconKey: 'skull', sortOrder: 31 },
      { slug: 'axe_throwing', name: 'Axe Throwing', iconKey: 'flash', sortOrder: 32 },
      { slug: 'shooting_range', name: 'Shooting Range', iconKey: 'locate', sortOrder: 33 },
      { slug: 'racing_track', name: 'Racing Track', iconKey: 'car', sortOrder: 34 },
      { slug: 'stadium', name: 'Stadium', iconKey: 'football', sortOrder: 35 },
      { slug: 'arena', name: 'Arena', iconKey: 'people', sortOrder: 36 },
    ],
  },
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      { slug: 'bank', name: 'Bank', iconKey: 'business', sortOrder: 1 },
      { slug: 'credit_union', name: 'Credit Union', iconKey: 'business', sortOrder: 2 },
      { slug: 'atm', name: 'ATM', iconKey: 'cash', sortOrder: 3 },
      { slug: 'check_cashing', name: 'Check Cashing', iconKey: 'cash', sortOrder: 4 },
      { slug: 'payday_loan', name: 'Payday Loan', iconKey: 'cash', sortOrder: 5 },
      { slug: 'money_transfer', name: 'Money Transfer', iconKey: 'swap-horizontal', sortOrder: 6 },
      { slug: 'currency_exchange', name: 'Currency Exchange', iconKey: 'swap-horizontal', sortOrder: 7 },
      { slug: 'financial_advisor', name: 'Financial Advisor', iconKey: 'trending-up', sortOrder: 8 },
      { slug: 'investment_firm', name: 'Investment Firm', iconKey: 'trending-up', sortOrder: 9 },
      { slug: 'stock_broker', name: 'Stock Broker', iconKey: 'stats-chart', sortOrder: 10 },
      { slug: 'insurance_agent', name: 'Insurance Agent', iconKey: 'shield', sortOrder: 11 },
      { slug: 'mortgage_broker', name: 'Mortgage Broker', iconKey: 'home', sortOrder: 12 },
      { slug: 'tax_preparer', name: 'Tax Preparer', iconKey: 'document', sortOrder: 13 },
      { slug: 'accountant', name: 'Accountant / CPA', iconKey: 'calculator', sortOrder: 14 },
      { slug: 'bookkeeper', name: 'Bookkeeper', iconKey: 'book', sortOrder: 15 },
      { slug: 'payroll_service', name: 'Payroll Service', iconKey: 'cash', sortOrder: 16 },
      { slug: 'debt_collection', name: 'Debt Collection', iconKey: 'cash', sortOrder: 17 },
      { slug: 'credit_repair', name: 'Credit Repair', iconKey: 'trending-up', sortOrder: 18 },
      { slug: 'bankruptcy', name: 'Bankruptcy Service', iconKey: 'document', sortOrder: 19 },
      { slug: 'pawn_shop', name: 'Pawn Shop', iconKey: 'cash', sortOrder: 20 },
      { slug: 'gold_buyer', name: 'Gold / Silver Buyer', iconKey: 'diamond', sortOrder: 21 },
      { slug: 'coin_dealer', name: 'Coin Dealer', iconKey: 'cash', sortOrder: 22 },
    ],
  },
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      ...
      { slug: 'border_crossing', name: 'Border Crossing / Customs', iconKey: 'flag', sortOrder: 32 },
      { slug: 'checkpoint', name: 'Checkpoint', iconKey: 'shield', sortOrder: 33 },
    ],
  },
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      ...
      { slug: 'informal_campsite', name: 'Informal Campsite', iconKey: 'bonfire', sortOrder: 11 },
      { slug: 'wild_camping', name: 'Wild Camping / Boondocking', iconKey: 'bonfire', sortOrder: 12 },
      { slug: 'farm_camping', name: 'Farm & Vineyard Camping', iconKey: 'leaf', sortOrder: 13 },
      { slug: 'rv_park', name: 'RV Park', iconKey: 'car', sortOrder: 14 },
      { slug: 'overnight_parking', name: 'Overnight Parking', iconKey: 'car', sortOrder: 15 },
      { slug: 'extended_stay', name: 'Extended Stay', iconKey: 'bed', sortOrder: 16 },
      { slug: 'aparthotel', name: 'Aparthotel', iconKey: 'bed', sortOrder: 17 },
      { slug: 'guest_house', name: 'Guest House', iconKey: 'home', sortOrder: 18 },
      { slug: 'lodge', name: 'Lodge', iconKey: 'bed', sortOrder: 19 },
      { slug: 'capsule_hotel', name: 'Capsule Hotel', iconKey: 'bed', sortOrder: 20 },
    ],
  },
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      ...
      { slug: 'pet_hospital', name: 'Pet Hospital', iconKey: 'medkit', sortOrder: 3 },
      { slug: 'pet_grooming', name: 'Pet Grooming', iconKey: 'cut', sortOrder: 4 },
      { slug: 'dog_grooming', name: 'Dog Grooming', iconKey: 'cut', sortOrder: 5 },
      { slug: 'cat_grooming', name: 'Cat Grooming', iconKey: 'cut', sortOrder: 6 },
      { slug: 'pet_boarding', name: 'Pet Boarding', iconKey: 'bed', sortOrder: 7 },
      { slug: 'dog_boarding', name: 'Dog Boarding', iconKey: 'bed', sortOrder: 8 },
      { slug: 'cat_boarding', name: 'Cat Boarding', iconKey: 'bed', sortOrder: 9 },
      { slug: 'doggy_daycare', name: 'Doggy Daycare', iconKey: 'happy', sortOrder: 10 },
      { slug: 'dog_training', name: 'Dog Training', iconKey: 'school', sortOrder: 11 },
      { slug: 'dog_walking', name: 'Dog Walking', iconKey: 'walk', sortOrder: 12 },
      { slug: 'pet_sitting', name: 'Pet Sitting', iconKey: 'home', sortOrder: 13 },
      { slug: 'pet_store_svc', name: 'Pet Store', iconKey: 'storefront', sortOrder: 14 },
      { slug: 'pet_supplies', name: 'Pet Supplies', iconKey: 'cart', sortOrder: 15 },
      { slug: 'pet_adoption', name: 'Pet Adoption', iconKey: 'heart', sortOrder: 16 },
      { slug: 'animal_shelter', name: 'Animal Shelter', iconKey: 'home', sortOrder: 17 },
      { slug: 'pet_rescue', name: 'Pet Rescue', iconKey: 'heart', sortOrder: 18 },
      { slug: 'pet_cremation', name: 'Pet Cremation', iconKey: 'flame', sortOrder: 19 },
      { slug: 'pet_cemetery', name: 'Pet Cemetery', iconKey: 'flower', sortOrder: 20 },
      { slug: 'aquarium_store', name: 'Aquarium Store', iconKey: 'fish', sortOrder: 21 },
      { slug: 'bird_store', name: 'Bird Store', iconKey: 'leaf', sortOrder: 22 },
      { slug: 'reptile_store', name: 'Reptile Store', iconKey: 'bug', sortOrder: 23 },
      { slug: 'horse_boarding', name: 'Horse Boarding', iconKey: 'paw', sortOrder: 24 },
      { slug: 'horse_training', name: 'Horse Training', iconKey: 'school', sortOrder: 25 },
      { slug: 'farrier', name: 'Farrier', iconKey: 'hammer', sortOrder: 26 },
      { slug: 'equine_vet', name: 'Equine Vet', iconKey: 'medkit', sortOrder: 27 },
    ],
  },
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      ...
      { slug: 'family_lawyer', name: 'Family Lawyer', iconKey: 'people', sortOrder: 2 },
      { slug: 'criminal_lawyer', name: 'Criminal Lawyer', iconKey: 'shield', sortOrder: 3 },
      { slug: 'personal_injury', name: 'Personal Injury Lawyer', iconKey: 'medkit', sortOrder: 4 },
      { slug: 'immigration_lawyer', name: 'Immigration Lawyer', iconKey: 'globe', sortOrder: 5 },
      { slug: 'real_estate_lawyer', name: 'Real Estate Lawyer', iconKey: 'home', sortOrder: 6 },
      { slug: 'business_lawyer', name: 'Business Lawyer', iconKey: 'briefcase', sortOrder: 7 },
      { slug: 'estate_planning', name: 'Estate Planning', iconKey: 'document', sortOrder: 8 },
      { slug: 'notary', name: 'Notary Public', iconKey: 'document', sortOrder: 9 },
      { slug: 'real_estate_agent', name: 'Real Estate Agent', iconKey: 'home', sortOrder: 10 },
      { slug: 'property_management', name: 'Property Management', iconKey: 'home', sortOrder: 11 },
      { slug: 'architect', name: 'Architect', iconKey: 'construct', sortOrder: 12 },
      { slug: 'engineer', name: 'Engineer', iconKey: 'construct', sortOrder: 13 },
      { slug: 'surveyor', name: 'Surveyor', iconKey: 'map', sortOrder: 14 },
      { slug: 'graphic_designer', name: 'Graphic Designer', iconKey: 'color-palette', sortOrder: 15 },
      { slug: 'web_designer', name: 'Web Designer', iconKey: 'globe', sortOrder: 16 },
      { slug: 'photographer_pro', name: 'Photographer', iconKey: 'camera', sortOrder: 17 },
      { slug: 'videographer', name: 'Videographer', iconKey: 'videocam', sortOrder: 18 },
      { slug: 'marketing_agency', name: 'Marketing Agency', iconKey: 'megaphone', sortOrder: 19 },
      { slug: 'pr_firm', name: 'PR Firm', iconKey: 'chatbubbles', sortOrder: 20 },
      { slug: 'advertising', name: 'Advertising Agency', iconKey: 'megaphone', sortOrder: 21 },
      { slug: 'consulting', name: 'Consulting', iconKey: 'briefcase', sortOrder: 22 },
      { slug: 'hr_services', name: 'HR Services', iconKey: 'people', sortOrder: 23 },
      { slug: 'staffing_agency', name: 'Staffing Agency', iconKey: 'people', sortOrder: 24 },
      { slug: 'it_services', name: 'IT Services', iconKey: 'desktop', sortOrder: 25 },
      { slug: 'computer_repair', name: 'Computer Repair', iconKey: 'desktop', sortOrder: 26 },
      { slug: 'phone_repair', name: 'Phone Repair', iconKey: 'phone-portrait', sortOrder: 27 },
      { slug: 'printing', name: 'Printing Services', iconKey: 'print', sortOrder: 28 },
      { slug: 'shipping', name: 'Shipping / Mailing', iconKey: 'mail', sortOrder: 29 },
      { slug: 'translation', name: 'Translation Services', iconKey: 'language', sortOrder: 30 },
      { slug: 'private_investigator', name: 'Private Investigator', iconKey: 'search', sortOrder: 31 },
      { slug: 'security_service', name: 'Security Service', iconKey: 'shield', sortOrder: 32 },
      { slug: 'event_planner', name: 'Event Planner', iconKey: 'calendar', sortOrder: 33 },
      { slug: 'wedding_planner', name: 'Wedding Planner', iconKey: 'heart', sortOrder: 34 },
      { slug: 'catering', name: 'Catering', iconKey: 'restaurant', sortOrder: 35 },
      { slug: 'dj_service', name: 'DJ Service', iconKey: 'musical-notes', sortOrder: 36 },
      { slug: 'entertainment_booking', name: 'Entertainment Booking', iconKey: 'mic', sortOrder: 37 },
  ...
  // ----------------------------------------
  {
    ...
    sortOrder: 20,
    multiEntrance: 'optional',
    optionalMultiEntranceSubcategories: ['established_campground', 'rv_park_camp'],
    subcategories: [
      { slug: 'established_campground', name: 'Established Campground', iconKey: 'bonfire', sortOrder: 1 },
      { slug: 'informal_campsite', name: 'Informal Campsite', iconKey: 'bonfire', sortOrder: 2 },
      { slug: 'wild_camping', name: 'Wild Camping / Boondocking', iconKey: 'bonfire', sortOrder: 3 },
      { slug: 'farm_camping', name: 'Farm & Vineyard Camping', iconKey: 'leaf', sortOrder: 4 },
      { slug: 'rv_park_camp', name: 'RV Park', iconKey: 'car', sortOrder: 5 },
      { slug: 'overnight_parking', name: 'Overnight Parking', iconKey: 'car', sortOrder: 6 },
      { slug: 'dump_station', name: 'Dump Station', iconKey: 'water', sortOrder: 7 },
      { slug: 'propane_station', name: 'Propane Station', iconKey: 'flame', sortOrder: 8 },
      { slug: 'water_fill_station', name: 'Water Fill Station', iconKey: 'water', sortOrder: 9 },
      { slug: 'public_showers', name: 'Public Showers', iconKey: 'water', sortOrder: 10 },
      { slug: 'laundromat', name: 'Laundromat', iconKey: 'shirt', sortOrder: 11 },
      { slug: 'wifi_hotspot', name: 'Wifi Hotspot', iconKey: 'wifi', sortOrder: 12 },
      { slug: 'picnic_area_camp', name: 'Picnic Area', iconKey: 'restaurant', sortOrder: 13 },
      { slug: 'restroom', name: 'Restroom', iconKey: 'water', sortOrder: 14 },
    ],
  },
