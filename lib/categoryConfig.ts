...
export const CONTENT_TYPES: ContentTypeConfig[] = [
  {
    ...
    icon: 'location',
    allowedCategories: [
      'restaurants', 'cafes', 'nightlife', 'lodging', 'rv_camping', 'shopping', 'beauty',
...
export const PRIMARY_CATEGORIES: PrimaryCategory[] = [
  ...
  // ----------------------------------------
  {
    ...
    subcategories: [
      ...
      { slug: 'propane_station', name: 'Propane Station', iconKey: 'flame', sortOrder: 26 },
      { slug: 'ev_charging', name: 'EV Charging Station', iconKey: 'flash', sortOrder: 27 },
      { slug: 'dump_station', name: 'Dump Station', iconKey: 'water', sortOrder: 28 },
      { slug: 'vehicle_storage', name: 'Vehicle Storage', iconKey: 'cube', sortOrder: 29 },
      { slug: 'vehicle_shipping', name: 'Vehicle Shipping', iconKey: 'boat', sortOrder: 30 },
      { slug: 'vehicle_insurance', name: 'Vehicle Insurance', iconKey: 'shield', sortOrder: 31 },
      { slug: 'auto_auction', name: 'Auto Auction', iconKey: 'car', sortOrder: 32 },
      { slug: 'dmv', name: 'DMV / Registration', iconKey: 'document', sortOrder: 33 },
    ],
  },
