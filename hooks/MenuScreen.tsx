  ...
  const menuItems = [
    {
      ...
      subtitle: user ? t('profile.viewEditProfile') : t('auth.signInRequired'),
      icon: 'person',
      screen: 'ProfileMain',
      color: theme.primary,
    },
    {
      id: 'saved',
      title: t('navigation.savedPlaces'),
      subtitle: t('places.saveToMyPlaces'),
      icon: 'bookmark',
      screen: 'SavedMain',
    ...
    {
      id: 'proDashboard',
      title: t('pros.proDashboard'),
      subtitle: t('pros.manageProfile'),
      icon: 'construct',
      screen: 'ProsDashboard',
      color: theme.signalUniverse, // Blue
    },
    // ========== Settings option (NOW NAVIGATES TO SETTINGS SCREEN) ==========
    {
      id: 'settings',
      title: t('navigation.settings'),
      subtitle: t('settings.appPreferences'),
      icon: 'settings',
      screen: 'Settings', // Now navigates to SettingsScreen
      color: theme.textSecondary,
    },
    {
      id: 'help',
      title: t('settings.helpSupport'),
      subtitle: t('settings.questionsOrConcerns'),
      icon: 'help-circle',
      screen: 'HelpSupport',
    ...
    <SafeAreaView style={[styles.container, dynamicStyles.container]}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        {user && (
          <View style={[styles.userCard, dynamicStyles.userCard]}>
            ...
            <View style={styles.userInfo}>
              ...
              <Text style={styles.userSubtitle}>{t('auth.tavvyMember')}</Text>
            </View>
          </View>
        )}
        ...
        <View style={styles.appInfo}>
          <Text style={[styles.appInfoText, dynamicStyles.appInfoText]}>
