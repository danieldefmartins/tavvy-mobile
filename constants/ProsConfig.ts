...
export const PROS_CATEGORIES = [
  ...
  { id: 3, name: 'Pool Contractor', slug: 'pool-contractor', icon: 'water-outline', color: '#06B6D4' },
  ...
  { id: 17, name: 'Home Remodeling', slug: 'home-remodeling', icon: 'hammer', color: '#7C3AED' },
  { id: 18, name: 'General Contractor', slug: 'general-contractor', icon: 'build', color: '#0EA5E9' },
  { id: 19, name: 'Home Builder', slug: 'home-builder', icon: 'business', color: '#DC2626' },
  { id: 20, name: 'Appliances', slug: 'appliances', icon: 'cube-outline', color: '#475569' },
  { id: 21, name: 'Architects & Engineers', slug: 'architects-engineers', icon: 'compass', color: '#059669' },
  { id: 22, name: 'Cabinets & Countertops', slug: 'cabinets-countertops', icon: 'cube', color: '#B45309' },
  { id: 23, name: 'Carpentry', slug: 'carpentry', icon: 'cut', color: '#CA8A04' },
  { id: 24, name: 'Carpet', slug: 'carpet', icon: 'ellipse', color: '#7C3AED' },
  { id: 25, name: 'Concrete & Masonry', slug: 'concrete-masonry', icon: 'layers', color: '#57534E' },
  { id: 26, name: 'Decks & Porches', slug: 'decks-porches', icon: 'expand', color: '#B45309' },
  { id: 27, name: 'Driveways & Patios', slug: 'driveways-patios', icon: 'trail-sign', color: '#65A30D' },
  { id: 28, name: 'Insulation', slug: 'insulation', icon: 'layers-outline', color: '#F59E0B' },
  { id: 29, name: 'Lawn Care & Sprinklers', slug: 'lawn-care-sprinklers', icon: 'rainy', color: '#16A34A' },
  { id: 30, name: 'Siding', slug: 'siding', icon: 'menu', color: '#0891B2' },
  { id: 31, name: 'Swimming Pools & Spas', slug: 'swimming-pools-spas', icon: 'water', color: '#0EA5E9' },
  { id: 32, name: 'Tile & Stone', slug: 'tile-stone', icon: 'grid-outline', color: '#78716C' },
  { id: 33, name: 'Walls & Ceilings', slug: 'walls-ceilings', icon: 'scan', color: '#A3A3A3' },
  { id: 34, name: 'Windows & Doors', slug: 'windows-doors', icon: 'browsers', color: '#0D9488' },
  { id: 35, name: 'Gutters', slug: 'gutters', icon: 'arrow-down', color: '#64748B' },
] as const;
